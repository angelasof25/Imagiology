...
path = f'/home/angela/Transferências/RX_torax/train/NORMAL'
path_ = f'/home/angela/Transferências/RX_torax/train/PNEUMONIA'
PATH = f'/home/angela/Transferências/RX_torax/'
teste = f'/home/angela/Transferências/RX_torax//test'


# contar o número de imagens de cada tipo
def directories(path1=path, path2=path_):

    list_dir = os.listdir(path1)
    list_dir2 = os.listdir(path2)
    list_teste1 = os.listdir(teste+'/NORMAL')
    list_teste2 = os.listdir(teste + '/PNEUMONIA')
    normal = 0
    bacteria = 0
    virus = 0
...
def treino_teste(casos_treino, casos_teste):
    ...
    checkpointer = ModelCheckpoint(filepath="melhor_modelo.h5", monitor='val_acc', verbose=1, save_best_only=True)
